...
class App {
    ...
    protected $controller = 'login'; // Default controller if no valid controller in URL
    protected $method = 'index';
    protected $special_url = ['apply'];
    protected $params = [];

    public function __construct() {
        // If authenticated, set the default controller to 'home'
        ...
        if (isset($url[1]) && file_exists(APPS . DS . 'controllers' . DS . $url[1] . '.php')) {
        ...
        // NO REDIRECT HERE. Let the default controller handle it directly.
        // This prevents an unnecessary redirect for the root URL.
